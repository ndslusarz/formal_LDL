...
Proof.
move => P H0 H1 H2 H3 H4 H7 H11 H12 H13 H14 H15 H16 H17 H18 H19 s e.
revert e.
revert s.
fix F1 2.
intros.
...
Fixpoint bool_translation {t} (e : @expr R t) : bool_type_translation t :=
  ...
  | ldl_lookup n v i => mktuple (fun => tnth << v >> << i >>)
  end
...
Fixpoint translation {t} (e : @expr R t) {struct e} : type_translation t :=
  ...
  | E1 `== E2 =>
      let e1 := tnth (translation E1) 0 in
      let e2 := tnth (translation E2) 0 in
...
Fixpoint dl2_ereal_translation {t} (e : @expr R t) {struct e} : ereal_type_translation t :=
  ...
  | E1 `== E2 => (- `| tnth {[ E1 ]} 0 - tnth {[ E2 ]} 0|)%:E
  | E1 `<= E2 => (- maxr (tnth {[ E1 ]} 0 - tnth {[ E2 ]} 0) 0)%:E
...
Fixpoint dl2_translation {t} (e : @expr R t) {struct e} : type_translation t :=
  ...
  | E1 `== E2 => (- `| tnth {[ E1 ]} 0 - tnth {[ E2 ]} 0|)
  | E1 `<= E2 => (- maxr (tnth {[ E1 ]} 0 - tnth {[ E2 ]} 0) 0)
...
Fixpoint stl_ereal_translation {t} (e : expr t) : ereal_type_translation t :=
  ...
  (*comparisons*)
  | E1 `== E2 => (- `| tnth {[ E1 ]} 0 - tnth {[ E2 ]} 0|)%:E
  | E1 `<= E2 => (tnth {[ E2 ]} 0 - tnth {[ E1 ]} 0)%:E(* (- maxr ({[ E1 ]} - {[ E2 ]}) 0)%:E *)
